...
function cartographicStyle(feature) {
    ...
    console.log("Geometry type: ", feature.properties.geometry_type, "Fill color: ", fillColor);
    return {
        fillColor: fillColor,
        weight: 0,
        opacity: 1,
...
export function createParishGeometryTypeMap(mapContainer, parcelData, parishData, geometryType) {
